...
class Solution_shortestPath_undirectedGraph_withUnitWt {
...
class Solution_shortestPath_DAG {
...
class Solution_course_scheduler_oneAndTwo {
...
class Solution_detect_cycle_undirected {
    private boolean[] vis;
    private ArrayList<ArrayList<Integer>> adj;
